...
export default function About() {
    const techStack = [
        { name: "TypeScript", color: "#3178C6", path: "M1.125 0C0.502 0 0 0.502 0 1.125v21.75C0 23.498 0.502 24 1.125 24h21.75c0.623 0 1.125-0.502 1.125-1.125V1.125C24 0.502 23.498 0 22.875 0H1.125zM15.563 16.804c0 1.765-1.554 2.932-3.832 2.932-1.343 0-2.455-0.344-3.197-0.796v-3.072l0.208-0.09c0.916 0.61 1.936 1.053 2.903 1.053 0.65 0 0.999-0.233 0.999-0.903 0-1.285-4.226-1.178-4.226-4.577 0-1.604 1.348-2.825 3.522-2.825 1.141 0 2.057 0.264 2.825 0.732v2.868l-0.18.096c-0.669-0.457-1.636-0.87-2.607-0.87-0.697 0-0.903 0.322-0.903 0.704 0 1.306 4.296 1.259 4.296 4.755zM21.577 19.53h-3.322v-9.36h-2.181V7.575h7.683v2.595h-2.181v9.36z" },
        { name: "React", color: "#61DAFB", path: "M12 2.5c-5.5 0-7.3 3.6-7.3 5.4 0 1.9 1.8 5.6 7.3 5.6 5.5 0 7.3-3.7 7.3-5.6 0-1.8-1.8-5.4-7.3-5.4m0 9.9c-2.3 0-3.9-1.3-4.7-2.6.7-1.4 2.4-2.7 4.7-2.7 2.3 0 3.9 1.3 4.7 2.6-.7 1.4-2.4 2.7-4.7 2.7" },
        { name: "Python", color: "#3776AB", path: "M12 2c-5.5 0-6 2.5-6 2.5v2.5h2.5V5s0-1 1.5-1 1.5.5 1.5 1.5v1h-3c-3 0-4.5 1.5-4.5 4s1.5 4 4.5 4h1.5v-1.5s0-1.5 1.5-1.5 1.5 0 1.5 1.5v1.5h1.5c3 0 4.5-1.5 4.5-4s-1.5-4-4.5-4h-2.5V5c0-3-.5-3-4.5-3z" },
        { name: "Java", color: "#007396", path: "M5.5 16c1.5 2 7.5 2 9 0M7 10s2-4 6-1" },
        ...
        { name: "GraphQL", color: "#E10098", path: "M12 2L4.5 6.3v8.4L12 19l7.5-4.3V6.3L12 2zM12 4.3l5.5 3.2-5.5 3.2-5.5-3.2L12 4.3z" },
        { name: "REST API", color: "#FF5733", path: "M4 4h16v16H4zM2 9h20M9 2v20" },
        { name: "PostgreSQL", color: "#336791", path: "M12 3c-4.42 0-8 1.79-8 4s3.58 4 8 4 8-1.79 8-4-3.58-4-8-4zM4 9v4c0 2.21 3.58 4 8 4s8-1.79 8-4V9c0 2.21-3.58 4-8 4s-8-1.79-8-4zm0 6v4c0 2.21 3.58 4 8 4s8-1.79 8-4v-4c0 2.21-3.58 4-8 4s-8-1.79-8-4z" },
        { name: "Redis", color: "#DC382D", path: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 16c-3.3 0-6-2.7-6-6s2.7-6 6-6 6 2.7 6 6-2.7 6-6 6z" },
        { name: "Docker", color: "#2496ED", path: "M4 11h3v3H4zm4 0h3v3H8zm4 0h3v3h-3zm4 0h3v3h-3zm-8-4h3v3H8zm4 0h3v3h-3zM2 15h20v4H2z" },
        { name: "Git", color: "#F05032", path: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 6h2v4h3l-4 4-4-4h3V8z" },
        { name: "Tauri", color: "#FFC131", path: "M22,6.5H12v15h10V6.5z M2,6h8v16H2V6z M2,2h20v2H2V2z" },
        { name: "Rust", color: "#DEA584", path: "M12 2C6.5 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm-1-13h2v14h-2zm-5 5h12v2H6z" },
